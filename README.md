...
2. **Submit a Proposal** — Prepare a concise proposal (≤ 5 pages) describing your dataset, collection methodology and target tasks. Submit to [openh.data+rf@gmail.com](mailto:openh.data+rf@gmail.com).
